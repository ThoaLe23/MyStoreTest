...
public class Action extends BaseClass{
	 ...
	 * @return - true/false
	 */
//	public void clearWebField(WebElement element)throws Throwable{
...
//	}
	...
	public static String screenShot(WebDriver driver, String filename) {
		...
		String destination = System.getProperty("user.dir") + "\\MyStoreE2E\\ScreenShots" + filename + "_" + dateName + ".png";
		...
		String newImageString = "http://localhost:3000/job/MyStoreProject/ws/MyStoreProject/ScreenShots/" + filename + "_"
				+ dateName + ".png";
